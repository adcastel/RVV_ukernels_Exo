...
for (int_fast32_t k = 0; k < KC; k++) {
  A_reg_0 = __riscv_vle32_v_f32m1(&A.data[(k) * (A.strides[0])],(8));
  A_regt = __riscv_vle32_v_f32m1(&A.data[(k) * (A.strides[0]) + 8],(2));
  C_reg_0_0 = __riscv_vfmacc_vf_f32m1C_reg_0_0, B.data[(k) * (B.strides[0])], A_reg_0,(8));
  C_reg_1_0 = __riscv_vfmacc_vf_f32m1C_reg_1_0, B.data[(k) * (B.strides[0]) + 1], A_reg_0,(8));
  C_reg_2_0 = __riscv_vfmacc_vf_f32m1C_reg_2_0, B.data[(k) * (B.strides[0]) + 2], A_reg_0,(8));
  C_reg_3_0 = __riscv_vfmacc_vf_f32m1C_reg_3_0, B.data[(k) * (B.strides[0]) + 3], A_reg_0,(8));
  C_reg_4_0 = __riscv_vfmacc_vf_f32m1C_reg_4_0, B.data[(k) * (B.strides[0]) + 4], A_reg_0,(8));
  C_reg_5_0 = __riscv_vfmacc_vf_f32m1C_reg_5_0, B.data[(k) * (B.strides[0]) + 5], A_reg_0,(8));
  C_reg_6_0 = __riscv_vfmacc_vf_f32m1C_reg_6_0, B.data[(k) * (B.strides[0]) + 6], A_reg_0,(8));
  C_reg_7_0 = __riscv_vfmacc_vf_f32m1C_reg_7_0, B.data[(k) * (B.strides[0]) + 7], A_reg_0,(8));
  C_regt_0 = __riscv_vfmacc_vf_f32m1C_regt_0, B.data[(k) * (B.strides[0])], A_regt,(2));
  C_regt_1 = __riscv_vfmacc_vf_f32m1C_regt_1, B.data[(k) * (B.strides[0]) + 1], A_regt,(2));
  C_regt_2 = __riscv_vfmacc_vf_f32m1C_regt_2, B.data[(k) * (B.strides[0]) + 2], A_regt,(2));
  C_regt_3 = __riscv_vfmacc_vf_f32m1C_regt_3, B.data[(k) * (B.strides[0]) + 3], A_regt,(2));
  C_regt_4 = __riscv_vfmacc_vf_f32m1C_regt_4, B.data[(k) * (B.strides[0]) + 4], A_regt,(2));
  C_regt_5 = __riscv_vfmacc_vf_f32m1C_regt_5, B.data[(k) * (B.strides[0]) + 5], A_regt,(2));
  C_regt_6 = __riscv_vfmacc_vf_f32m1C_regt_6, B.data[(k) * (B.strides[0]) + 6], A_regt,(2));
  C_regt_7 = __riscv_vfmacc_vf_f32m1C_regt_7, B.data[(k) * (B.strides[0]) + 7], A_regt,(2));
}
__riscv_vse32_v_f32m1(&C.data[0], C_reg_0_0,(8));
__riscv_vse32_v_f32m1(&C.data[C.strides[0]], C_reg_1_0,(8));
__riscv_vse32_v_f32m1(&C.data[(2) * (C.strides[0])], C_reg_2_0,(8));
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  C_reg_6_0 = __riscv_vfmacc_vf_f32m1C_reg_6_0, B.data[(k) * (B.strides[0]) + 6], A_reg_0,(8));
  C_reg_7_0 = __riscv_vfmacc_vf_f32m1C_reg_7_0, B.data[(k) * (B.strides[0]) + 7], A_reg_0,(8));
  C_regt_0 = __riscv_vfmacc_vf_f32m1C_regt_0, B.data[(k) * (B.strides[0])], A_regt,(3));
  C_regt_1 = __riscv_vfmacc_vf_f32m1C_regt_1, B.data[(k) * (B.strides[0]) + 1], A_regt,(3));
  C_regt_2 = __riscv_vfmacc_vf_f32m1C_regt_2, B.data[(k) * (B.strides[0]) + 2], A_regt,(3));
  C_regt_3 = __riscv_vfmacc_vf_f32m1C_regt_3, B.data[(k) * (B.strides[0]) + 3], A_regt,(3));
  C_regt_4 = __riscv_vfmacc_vf_f32m1C_regt_4, B.data[(k) * (B.strides[0]) + 4], A_regt,(3));
  C_regt_5 = __riscv_vfmacc_vf_f32m1C_regt_5, B.data[(k) * (B.strides[0]) + 5], A_regt,(3));
  C_regt_6 = __riscv_vfmacc_vf_f32m1C_regt_6, B.data[(k) * (B.strides[0]) + 6], A_regt,(3));
  C_regt_7 = __riscv_vfmacc_vf_f32m1C_regt_7, B.data[(k) * (B.strides[0]) + 7], A_regt,(3));
}
__riscv_vse32_v_f32m1(&C.data[0], C_reg_0_0,(8));
__riscv_vse32_v_f32m1(&C.data[C.strides[0]], C_reg_1_0,(8));
__riscv_vse32_v_f32m1(&C.data[(2) * (C.strides[0])], C_reg_2_0,(8));
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  C_reg_6_0 = __riscv_vfmacc_vf_f32m1C_reg_6_0, B.data[(k) * (B.strides[0]) + 6], A_reg_0,(8));
  C_reg_7_0 = __riscv_vfmacc_vf_f32m1C_reg_7_0, B.data[(k) * (B.strides[0]) + 7], A_reg_0,(8));
  C_regt_0 = __riscv_vfmacc_vf_f32m1C_regt_0, B.data[(k) * (B.strides[0])], A_regt,(4));
  C_regt_1 = __riscv_vfmacc_vf_f32m1C_regt_1, B.data[(k) * (B.strides[0]) + 1], A_regt,(4));
  C_regt_2 = __riscv_vfmacc_vf_f32m1C_regt_2, B.data[(k) * (B.strides[0]) + 2], A_regt,(4));
  C_regt_3 = __riscv_vfmacc_vf_f32m1C_regt_3, B.data[(k) * (B.strides[0]) + 3], A_regt,(4));
  C_regt_4 = __riscv_vfmacc_vf_f32m1C_regt_4, B.data[(k) * (B.strides[0]) + 4], A_regt,(4));
  C_regt_5 = __riscv_vfmacc_vf_f32m1C_regt_5, B.data[(k) * (B.strides[0]) + 5], A_regt,(4));
  C_regt_6 = __riscv_vfmacc_vf_f32m1C_regt_6, B.data[(k) * (B.strides[0]) + 6], A_regt,(4));
  C_regt_7 = __riscv_vfmacc_vf_f32m1C_regt_7, B.data[(k) * (B.strides[0]) + 7], A_regt,(4));
}
__riscv_vse32_v_f32m1(&C.data[0], C_reg_0_0,(8));
__riscv_vse32_v_f32m1(&C.data[C.strides[0]], C_reg_1_0,(8));
__riscv_vse32_v_f32m1(&C.data[(2) * (C.strides[0])], C_reg_2_0,(8));
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  C_reg_6_0 = __riscv_vfmacc_vf_f32m1C_reg_6_0, B.data[(k) * (B.strides[0]) + 6], A_reg_0,(8));
  C_reg_7_0 = __riscv_vfmacc_vf_f32m1C_reg_7_0, B.data[(k) * (B.strides[0]) + 7], A_reg_0,(8));
  C_regt_0 = __riscv_vfmacc_vf_f32m1C_regt_0, B.data[(k) * (B.strides[0])], A_regt,(5));
  C_regt_1 = __riscv_vfmacc_vf_f32m1C_regt_1, B.data[(k) * (B.strides[0]) + 1], A_regt,(5));
  C_regt_2 = __riscv_vfmacc_vf_f32m1C_regt_2, B.data[(k) * (B.strides[0]) + 2], A_regt,(5));
  C_regt_3 = __riscv_vfmacc_vf_f32m1C_regt_3, B.data[(k) * (B.strides[0]) + 3], A_regt,(5));
  C_regt_4 = __riscv_vfmacc_vf_f32m1C_regt_4, B.data[(k) * (B.strides[0]) + 4], A_regt,(5));
  C_regt_5 = __riscv_vfmacc_vf_f32m1C_regt_5, B.data[(k) * (B.strides[0]) + 5], A_regt,(5));
  C_regt_6 = __riscv_vfmacc_vf_f32m1C_regt_6, B.data[(k) * (B.strides[0]) + 6], A_regt,(5));
  C_regt_7 = __riscv_vfmacc_vf_f32m1C_regt_7, B.data[(k) * (B.strides[0]) + 7], A_regt,(5));
}
__riscv_vse32_v_f32m1(&C.data[0], C_reg_0_0,(8));
__riscv_vse32_v_f32m1(&C.data[C.strides[0]], C_reg_1_0,(8));
__riscv_vse32_v_f32m1(&C.data[(2) * (C.strides[0])], C_reg_2_0,(8));
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  C_reg_6_0 = __riscv_vfmacc_vf_f32m1C_reg_6_0, B.data[(k) * (B.strides[0]) + 6], A_reg_0,(8));
  C_reg_7_0 = __riscv_vfmacc_vf_f32m1C_reg_7_0, B.data[(k) * (B.strides[0]) + 7], A_reg_0,(8));
  C_regt_0 = __riscv_vfmacc_vf_f32m1C_regt_0, B.data[(k) * (B.strides[0])], A_regt,(6));
  C_regt_1 = __riscv_vfmacc_vf_f32m1C_regt_1, B.data[(k) * (B.strides[0]) + 1], A_regt,(6));
  C_regt_2 = __riscv_vfmacc_vf_f32m1C_regt_2, B.data[(k) * (B.strides[0]) + 2], A_regt,(6));
  C_regt_3 = __riscv_vfmacc_vf_f32m1C_regt_3, B.data[(k) * (B.strides[0]) + 3], A_regt,(6));
  C_regt_4 = __riscv_vfmacc_vf_f32m1C_regt_4, B.data[(k) * (B.strides[0]) + 4], A_regt,(6));
  C_regt_5 = __riscv_vfmacc_vf_f32m1C_regt_5, B.data[(k) * (B.strides[0]) + 5], A_regt,(6));
  C_regt_6 = __riscv_vfmacc_vf_f32m1C_regt_6, B.data[(k) * (B.strides[0]) + 6], A_regt,(6));
  C_regt_7 = __riscv_vfmacc_vf_f32m1C_regt_7, B.data[(k) * (B.strides[0]) + 7], A_regt,(6));
}
__riscv_vse32_v_f32m1(&C.data[0], C_reg_0_0,(8));
__riscv_vse32_v_f32m1(&C.data[C.strides[0]], C_reg_1_0,(8));
__riscv_vse32_v_f32m1(&C.data[(2) * (C.strides[0])], C_reg_2_0,(8));
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  C_reg_6_0 = __riscv_vfmacc_vf_f32m1C_reg_6_0, B.data[(k) * (B.strides[0]) + 6], A_reg_0,(8));
  C_reg_7_0 = __riscv_vfmacc_vf_f32m1C_reg_7_0, B.data[(k) * (B.strides[0]) + 7], A_reg_0,(8));
  C_regt_0 = __riscv_vfmacc_vf_f32m1C_regt_0, B.data[(k) * (B.strides[0])], A_regt,(7));
  C_regt_1 = __riscv_vfmacc_vf_f32m1C_regt_1, B.data[(k) * (B.strides[0]) + 1], A_regt,(7));
  C_regt_2 = __riscv_vfmacc_vf_f32m1C_regt_2, B.data[(k) * (B.strides[0]) + 2], A_regt,(7));
  C_regt_3 = __riscv_vfmacc_vf_f32m1C_regt_3, B.data[(k) * (B.strides[0]) + 3], A_regt,(7));
  C_regt_4 = __riscv_vfmacc_vf_f32m1C_regt_4, B.data[(k) * (B.strides[0]) + 4], A_regt,(7));
  C_regt_5 = __riscv_vfmacc_vf_f32m1C_regt_5, B.data[(k) * (B.strides[0]) + 5], A_regt,(7));
  C_regt_6 = __riscv_vfmacc_vf_f32m1C_regt_6, B.data[(k) * (B.strides[0]) + 6], A_regt,(7));
  C_regt_7 = __riscv_vfmacc_vf_f32m1C_regt_7, B.data[(k) * (B.strides[0]) + 7], A_regt,(7));
}
__riscv_vse32_v_f32m1(&C.data[0], C_reg_0_0,(8));
__riscv_vse32_v_f32m1(&C.data[C.strides[0]], C_reg_1_0,(8));
__riscv_vse32_v_f32m1(&C.data[(2) * (C.strides[0])], C_reg_2_0,(8));
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  A_reg_1 = __riscv_vle32_v_f32m1(&A.data[(k) * (A.strides[0]) + 8],(8));
  C_reg_0_0 = __riscv_vfmacc_vf_f32m1C_reg_0_0, B.data[(k) * (B.strides[0])], A_reg_0,(8));
  C_reg_0_1 = __riscv_vfmacc_vf_f32m1C_reg_0_1, B.data[(k) * (B.strides[0])], A_reg_1,(8));
  C_reg_1_0 = __riscv_vfmacc_vf_f32m1C_reg_1_0, B.data[(k) * (B.strides[0]) + 1], A_reg_0,(8));
  C_reg_1_1 = __riscv_vfmacc_vf_f32m1C_reg_1_1, B.data[(k) * (B.strides[0]) + 1], A_reg_1,(8));
  C_reg_2_0 = __riscv_vfmacc_vf_f32m1C_reg_2_0, B.data[(k) * (B.strides[0]) + 2], A_reg_0,(8));
  C_reg_2_1 = __riscv_vfmacc_vf_f32m1C_reg_2_1, B.data[(k) * (B.strides[0]) + 2], A_reg_1,(8));
  C_reg_3_0 = __riscv_vfmacc_vf_f32m1C_reg_3_0, B.data[(k) * (B.strides[0]) + 3], A_reg_0,(8));
  C_reg_3_1 = __riscv_vfmacc_vf_f32m1C_reg_3_1, B.data[(k) * (B.strides[0]) + 3], A_reg_1,(8));
  C_reg_4_0 = __riscv_vfmacc_vf_f32m1C_reg_4_0, B.data[(k) * (B.strides[0]) + 4], A_reg_0,(8));
  C_reg_4_1 = __riscv_vfmacc_vf_f32m1C_reg_4_1, B.data[(k) * (B.strides[0]) + 4], A_reg_1,(8));
  C_reg_5_0 = __riscv_vfmacc_vf_f32m1C_reg_5_0, B.data[(k) * (B.strides[0]) + 5], A_reg_0,(8));
  C_reg_5_1 = __riscv_vfmacc_vf_f32m1C_reg_5_1, B.data[(k) * (B.strides[0]) + 5], A_reg_1,(8));
  C_reg_6_0 = __riscv_vfmacc_vf_f32m1C_reg_6_0, B.data[(k) * (B.strides[0]) + 6], A_reg_0,(8));
  C_reg_6_1 = __riscv_vfmacc_vf_f32m1C_reg_6_1, B.data[(k) * (B.strides[0]) + 6], A_reg_1,(8));
  C_reg_7_0 = __riscv_vfmacc_vf_f32m1C_reg_7_0, B.data[(k) * (B.strides[0]) + 7], A_reg_0,(8));
  C_reg_7_1 = __riscv_vfmacc_vf_f32m1C_reg_7_1, B.data[(k) * (B.strides[0]) + 7], A_reg_1,(8));
}
__riscv_vse32_v_f32m1(&C.data[0], C_reg_0_0,(8));
__riscv_vse32_v_f32m1(&C.data[8], C_reg_0_1,(8));
__riscv_vse32_v_f32m1(&C.data[C.strides[0]], C_reg_1_0,(8));
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  C_reg_6_0 = __riscv_vfmacc_vf_f32m1C_reg_6_0, B.data[(k) * (B.strides[0]) + 6], A_reg_0,(8));
  C_reg_7_0 = __riscv_vfmacc_vf_f32m1C_reg_7_0, B.data[(k) * (B.strides[0]) + 7], A_reg_0,(8));
  C_regt_0 = __riscv_vfmacc_vf_f32m1C_regt_0, B.data[(k) * (B.strides[0])], A_regt,(1));
  C_regt_1 = __riscv_vfmacc_vf_f32m1C_regt_1, B.data[(k) * (B.strides[0]) + 1], A_regt,(1));
  C_regt_2 = __riscv_vfmacc_vf_f32m1C_regt_2, B.data[(k) * (B.strides[0]) + 2], A_regt,(1));
  C_regt_3 = __riscv_vfmacc_vf_f32m1C_regt_3, B.data[(k) * (B.strides[0]) + 3], A_regt,(1));
  C_regt_4 = __riscv_vfmacc_vf_f32m1C_regt_4, B.data[(k) * (B.strides[0]) + 4], A_regt,(1));
  C_regt_5 = __riscv_vfmacc_vf_f32m1C_regt_5, B.data[(k) * (B.strides[0]) + 5], A_regt,(1));
  C_regt_6 = __riscv_vfmacc_vf_f32m1C_regt_6, B.data[(k) * (B.strides[0]) + 6], A_regt,(1));
  C_regt_7 = __riscv_vfmacc_vf_f32m1C_regt_7, B.data[(k) * (B.strides[0]) + 7], A_regt,(1));
}
__riscv_vse32_v_f32m1(&C.data[0], C_reg_0_0,(8));
__riscv_vse32_v_f32m1(&C.data[C.strides[0]], C_reg_1_0,(8));
__riscv_vse32_v_f32m1(&C.data[(2) * (C.strides[0])], C_reg_2_0,(8));
