       ...
       do 
          ...
          do
	          ...
	          do	    
	            ...
	            dest=kernels/${ARCH}_${bits}_BASE_TOTAL/fp${prec}/${mr}x${nr}/${ss}/${gg}
	            destldX=kernels/${ARCH}_${bits}_LDX_TOTAL/fp${prec}/${mr}x${nr}/${ss}/${gg}
              ...
              if ! test -f ${dest}/${ff}.c; then
	              echo "${mr} ${nr} ${lane} ${prec} ${swap} ${gather} 1 1000 | exocc -o ${dest} --stem ${ff} RVV_generator_macc.py" 
	              echo "${mr} ${nr} ${lane} ${prec} ${swap} ${gather} 1 1000" | exocc -o ${dest} --stem ${ff} RVV_generator_macc.py
	            else
              ...
              echo "python3 generate_matrix_base.py ${mr} ${nr} ${lane} ${ARCH} fp${prec} fp${prec} fp${prec} ${swap} ${gather}"
	            ...
	            python3 generate_matrix.py ${mr} ${nr} ${lane} ${ARCH} fp${prec} fp${prec} fp${prec} ${swap} ${gather} LDX_TOTAL
